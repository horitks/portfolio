...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"property":"og:title","content":"poriweb"},{"name":"format-detection","content":"telephone=no, email=no, address=no"},{"name":"description","content":"pori(@t_pori418)の個人サイトです。開発したもの等を載せていくかもしれません。"},{"name":"keywords","content":"poriweb,pori,t_hori418,Web,Vue.js"},{"name":"author","content":"pori"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"portfolio","htmlAttrs":{"lang":"ja"}};
